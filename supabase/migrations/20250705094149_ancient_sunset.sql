/*
  # Database Schema Migration for Reinee E-commerce

  1. Schema Updates
    - Add missing columns to products table (category, shopee_link)
    - Convert price column from numeric to text safely
    - Create product_colors table for normalized color storage
    - Add created_at to hero table

  2. Security
    - Enable RLS on all tables
    - Add public read policies for browsing
    - Add admin-only write policies for management

  3. Data Migration
    - Insert collections data
    - Insert hero banner data
    - Insert all products with proper relationships
    - Insert product colors with normalized structure

  4. Constraints
    - Add unique constraints for proper conflict handling
