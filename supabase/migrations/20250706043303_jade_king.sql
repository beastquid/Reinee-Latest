/*
  # Complete Product Data Migration with Fixed Policies

  1. New Tables
    - All products with proper collections assignment
    - Product colors for each product
    - Comprehensive product catalog

  2. Security
    - Drop and recreate RLS policies to avoid duplication
    - Ensure proper access control for products and colors

  3. Data
    - 22 products across 4 collections
    - Complete color variants for each product
    - Proper Shopee links and pricing
*/
...
-- Insert all products and their colors
DO $$
DECLARE
